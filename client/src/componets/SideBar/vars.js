...
const div1 = isMobile ? 
  'sm:container sm:w-screen sm:bg-indigo-50 sm:px-10 sm:ml-0 sm:text-base sm:py-5 sm:w-16 sm:fixed sm:top-1/2 sm:left-0 sm:transform sm:-translate-y-1/2 sm:rounded-full sm:flex-shrink-0 sm:flex sm:items-center sm:justify-center sm:border-purple-50' 
  : 
